...
public class ColoredObjectTrack implements Runnable {
     ...
     * environment.
     */
    static CvScalar red_min = cvScalar(0, 0, 130, 0);// RED 
    static CvScalar red_max = cvScalar(80, 80, 255, 0);
    
    static CvScalar green_min = cvScalar(0, 40, 0, 0);
    static CvScalar green_max = cvScalar(50, 255, 50, 0);

    static CvScalar blue_min = cvScalar(150, 0, 0, 0);
    static CvScalar blue_max = cvScalar(255, 150, 150, 0);
    
    static CvScalar yellow_min = cvScalar(0, 120, 120, 0);
    static CvScalar yellow_max = cvScalar(90, 255, 255, 0);
